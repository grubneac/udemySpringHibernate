...
public class MyDemoLoggingAspect {
	@After("execution(* com.Luv2code.aopdemo.dao.AccountDAO.fiendAccounts(..))")
	public void afterReturningFindAccountAdvice(JoinPoint theJoinPoint) {
		//print out which method we are advising on
		System.out.println("\n========>>> Executing @After (finaly) method:"+theJoinPoint.getSignature().toShortString());
	...
	public void afterReturningFindAccountAdvice(JoinPoint theJoinPoint,
			Throwable theExc ){
		//print out which method we are advising on
		System.out.println("\n========>>> Executing @AfterThrowing method:"+theJoinPoint.getSignature().toShortString());
